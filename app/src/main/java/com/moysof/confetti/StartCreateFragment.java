...
import com.moysof.confetti.util.ProgressHttpEntityWrapper;
import com.moysof.confetti.util.Util;
import com.moysof.confetti.view.DrawingView;
...
public class StartCreateFragment extends Fragment {
        ...
        protected Boolean doInBackground(final Void... params) {
            ...
            for (int i = 0; i < cardsCount; i++) {
                builder.addPart("card" + i, new FileBody(new File(Environment
                        .getExternalStorageDirectory() + "/.Confetti/card" + i + ".png")));
            }
    ...
    private Boolean saveCard() {
        File myDir = new File(Environment.getExternalStorageDirectory() + "/.Confetti/");
        if (!myDir.exists()) {
            if (!myDir.mkdirs()) {
